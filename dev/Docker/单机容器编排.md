...
​​![image](assets/image-20230306064856-rvomg90.png)​​
...
​​![image](assets/image-20230306064904-3fb7rxv.png)​​
...
​​![image](assets/image-20230306064908-svqozgj.png)​​
...
​​![image](assets/image-20230306064913-8bepwo8.png)​​

​​![image](assets/image-20230306064916-lsg9ug6.png)​​

看到 Running 4/4 就表示已经部署成功了，我们现在到服务器这边来看看情况：

​​![image](assets/image-20230306064924-58x5ohp.png)​​

可以看到，这里确实是按照我们的配置，创建了3个容器，并且都是处于运行中，可以正常访问：

​​![image](assets/image-20230306065000-nnm7w5v.png)​​

如果想要结束的话，我们只需要点击停止就行了：

​​![image](assets/image-20230306065003-1kkdbds.png)​​

当然如果我们不再需要这套环境的话，可以直接点击下方的按钮，将整套编排给down掉，这样的话相对应的容器也会被清理的：

​​![image](assets/image-20230306065006-7ee3n4x.png)​​

​​![image](assets/image-20230306065011-729hgak.png)​​

注意在使用docker-compose部署时，会自动创建一个新的自定义网络，并且所有的容器都是连接到这个自定义的网络里面：

​​![image](assets/image-20230306065015-qvuwyfs.png)​​

这个网络默认也是使用bridge作为驱动：

​​![image](assets/image-20230306065020-syqaeu2.png)​​
...
​​![image](assets/image-20230306065027-db4vq90.png)​​

现在我们重新部署docker-compos吧：

​​![image](assets/image-20230306065031-vkue3qo.png)​​

当三个服务全部为蓝色时，就表示已经正常运行了，现在我们来测试一下吧：

​​![image](assets/image-20230306065035-sfx9oo3.png)​​

接着我们来试试看向数据库传入数据：

​​![image](assets/image-20230306065038-n35kt6y.png)​​

​​![image](assets/image-20230306065041-c3j1sed.png)​​

可以看到响应成功，接着我们来请求一下：

​​![image](assets/image-20230306065045-i89mluw.png)​​
...
​​![image](assets/image-20230306065049-s5f4gy4.png)​​

​​![image](assets/image-20230306065053-wxm0y78.png)​​
